...
namespace App\Filament\Organization\Resources\Products\Widgets;
...
class ProductsOverview extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $productsQuery = Product::query()->when(
            $organizationId,
            fn (Builder $query, int $organizationId): Builder => $query->where('organization_id', $organizationId),
